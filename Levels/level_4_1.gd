...
func _ready() -> void:
	...
	skelet_1.position = Vector2 (382, 529)
	skelet_2.position = Vector2 (898, 546)
	skelet_3.position = Vector2 (1089, 274)
...
func _process(delta: float) -> void:
	if Input.is_action_just_pressed("interact_f") and door_ch:
		...
		music.stop()
		get_tree().change_scene_to_file("res://Levels/Level_4_2.tscn")	
